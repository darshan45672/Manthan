...
class BoardMembersExporter extends Exporter
{
    ...
    {
        $body = 'Your board members export has completed and ' . number_format($export->successful_rows) . ' ' . str('row')->plural($export->successful_rows) . ' exported.';

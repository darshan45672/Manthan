...
class HoDExporter extends Exporter
{
    ...
    {
        $body = 'Your ho d export has completed and ' . number_format($export->successful_rows) . ' ' . str('row')->plural($export->successful_rows) . ' exported.';

...
<section class="hero-section-2 overflow-hidden">
    <div class="hero-bg-wrap">
        <div class="hero-bg"><img src="{{ asset('ui/assets/img/bg-img/hero-bg.png') }}" alt="hero"></div>
        <div class="hero-bg-shape"><img src="{{ asset('ui/assets/img/shapes/hero-bg-shape.png') }}" alt="hero"></div>
        <div class="faq-text-box">
            <h4 class="student">Instructor</h4>
            <div class="faq-thumb-list-wrap">
                <ul class="faq-thumb-list">
                    <li><img src="{{ asset('ui/assets/img/images/faq-thumb-1.png') }}" alt="faq"></li>
                    <li><img src="{{ asset('ui/assets/img/images/faq-thumb-1.png') }}" alt="faq"></li>
                    <li><img src="{{ asset('ui/assets/img/images/faq-thumb-1.png') }}" alt="faq"></li>
                    <li><img src="{{ asset('ui/assets/img/images/faq-thumb-1.png') }}" alt="faq"></li>
                    <li><img src="{{ asset('ui/assets/img/images/faq-thumb-1.png') }}" alt="faq"></li>
                ...
                <p><span>2000+</span> <br>Faculties</p>
            </div>
        </div>
    ...
    <div class="shapes">
        <div class="shape shape-1"><img src="{{ asset('ui/assets/img/shapes/hero-shape-11.png') }}" alt="shape"></div>
        <div class="shape shape-2"><img src="{{ asset('ui/assets/img/shapes/hero-shape-11.png') }}" alt="shape"></div>
    </div>
    <div class="container">
                ...
                <div class="hero-content-2">
                    <div class="section-heading mb-20">
                        <h4 class="sub-heading wow fade-in-bottom" data-wow-delay="200ms">
                            ...
                            </span>Welcome to Manthan - AICTE Activity/Event Management System
                        </h4>
                    ...
                    <p class="desc">This system fosters skills such as leadership, teamwork, social responsibility and
                        communication,
...
<section class="course-section bg-grey pt-120 pb-120">
    <div class="shapes">
        <div class="shape shape-1"><img src="{{ asset('ui/assets/img/shapes/feature-shape-3.png') }}" alt="shape"></div>
        <div class="shape shape-2"><img src="{{ asset('ui/assets/img/shapes/feature-shape-4.png') }}" alt="shape"></div>
    </div>
    <div class="container">
        ...
        <div class="row gy-4">
            @if ($events->isEmpty())
            <center>
                <h1 class="display-6">No Events Found</h1>
            </center>
            @endif
            ...
            <div class="row gy-xl-0 gy-4 justify-content-center">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                    <div class="feature-item text-center wow fade-in-bottom" data-wow-delay="200ms">
                        <div class="icon"><img src="{{ asset('ui/assets/img/icon/feature-1.png') }}" alt="feature"></div>
    ...
    <div class="container">
        <div class="section-heading text-center">
            <h4 class="sub-heading wow fade-in-bottom" data-wow-delay="200ms">
                <span class="heading-icon">
                    <i class="fa-sharp fa-solid fa-bolt"></i>
                </span>Top Class Events</h4>
            <h2 class="section-title wow fade-in-bottom" data-wow-delay="400ms">Explore Featured Events</h2>
        </div>
        <div class="row gy-xl-0 gy-4 justify-content-center">

            @if ($events->where('is_featured', true)->isEmpty())
            <center>
                <h1 class="display-6">No Featured Events Found</h1>
            </center>
            @endif
...
<section class="cta-section pt-140 pb-140">
    <div class="cta-bg-img"><img src="{{ asset('ui/assets/img/bg-img/cta-bg-img.png') }}" alt="cta"></div>
    <div class="shapes">
        <div class="shape-1"><img src="{{ asset('ui/assets/img/shapes/dot-shape.png') }}" alt="shape"></div>
        <div class="shape-2"><img src="{{ asset('ui/assets/img/shapes/dot-shape.png') }}" alt="shape"></div>
    </div>
    <div class="container">
        <div class="cta-content">
            <h2 class="title wow fade-in-bottom" data-wow-delay="200ms">Join Us in Revolutionizing Technical Education </h2>
            ...
            <div class="cta-btn-wrap wow fade-in-bottom" data-wow-delay="500ms">
                <a href="contact.html" class="ed-primary-btn cta-btn">Login<i class="fa-regular fa-arrow-right"></i></a>
                <a href="contact.html" class="ed-primary-btn cta-btn-2">Register<i class="fa-regular fa-arrow-right"></i></a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-12">
                <div class="faq-img-wrap-2 wow fade-in-left" data-wow-delay="400ms">
                    <div class="faq-img-1"><img src="{{ asset('ui/assets/img/images/faq-img-2.png') }}" alt="faq"></div>
                    <div class="faq-img-2"><img src="{{ asset('ui/assets/img/images/faq-img-2.png') }}" alt="faq"></div>
                    <div class="faq-img-3"><img src="{{ asset('ui/assets/img/images/faq-img-2.png') }}" alt="faq"></div>
                    <div class="faq-text-box">
                        <h4 class="student">Instructor</h4>
                        <div class="faq-thumb-list-wrap">
                            <ul class="faq-thumb-list">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="faq-content">
                    <div class="section-heading mb-30">
                        <h4 class="sub-heading wow fade-in-bottom" data-wow-delay="200ms"><span class="heading-icon"><i class="fa-sharp fa-solid fa-bolt"></i></span>
                            Our Course Categories</h4>
                        <h2 class="section-title wow fade-in-bottom" data-wow-delay="400ms">Shaping Future Engineers
                        </h2>
                    </div>
                            ...
                            <div class="accordion-item wow fade-in-bottom" data-wow-delay="400ms">
                                <h2 class="accordion-header" id="headingOne">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        ...
                                        <span>01.</span>Easy Tracking of Activity Points
                                    </button>
                                </h2>
                            ...
                            <div class="accordion-item wow fade-in-bottom" data-wow-delay="200ms">
                                <h2 class="accordion-header" id="headingTwo">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        aria-controls="collapseTwo"><span>02.</span>
                                        Streamlined VerificationProcess
                                    </button>
                                </h2>
                            ...
                            <div class="accordion-item wow fade-in-bottom" data-wow-delay="200ms">
                                <h2 class="accordion-header" id="headingThree">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        <span>03.</span>
                                        Effective Communication of AICTE Programs
                                    </button>
                                </h2>
...
<section class="team-section pb-120">
    <div class="container">
        <div class="team-top heading-space">
            <div class="section-heading mb-0">
                <h4 class="sub-heading wow fade-in-bottom" data-wow-delay="200ms"><span class="heading-icon"><i
                            class="fa-sharp fa-solid fa-bolt"></i></span>Our Accredates</h4>
                <h2 class="section-title wow fade-in-bottom" data-wow-delay="400ms">Meet Our Accredated Colleges</h2>
            </div>
    ...
    <div class="team-container">
        <div class="row gy-xl-0 gy-4 justify-content-center">
            @if ($colleges->isEmpty())
            <center>
                <h1 class="display-6">No Colleges Found</h1>
            </center>
            @endif
...
<section class="testimonial-section pt-120 pb-120">
    <div class="shapes">
        <div class="shape-1"><img src="{{ asset('ui/assets/img/shapes/testi-shape-1.png') }}" alt="testi"></div>
        <div class="shape-2"><img src="{{ asset('ui/assets/img/shapes/testi-shape-1.png') }}" alt="testi"></div>
    </div>
    <div class="container">
        ...
        <center>
            <h1 class="display-6">No Testimonials Found</h1>
        </center>
        @else
...
<section class="blog-section pt-120 pb-120">
    <div class="container">
        ...
        <div class="row gy-lg-0 gy-4 justify-content-center post-card-2-wrap">
            @if ($posts->isEmpty())
            <center>
                <h1 class="display-6">No Blogs Found</h1>
            </center>
            @endif
